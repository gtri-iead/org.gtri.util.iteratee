...
class BoxSpec extends FunSpec {
  ...
  describe("A Box[+A]") {
    ...
    it("should be able to append log messages") {
    ...
    it("should be able to accumulate log messages in a for-comprehension") {
      val b1 : Box[Int] = Box(issue1, 1)
    ...
    it("should be able to retrieve log messages from recovery") {
